...
namespace AKStreamWeb.Services
{
    public static class AKStreamKeeperService
    {
        ...
        public static ResKeeperStartMediaServer StartMediaServer(string mediaServerId, out ResponseStruct rs)
        {
            ...
            Expression<Func<VideoChannelMediaInfo, bool>> lanbda = (d => d.MediaServerId.Equals(mediaServerId));
            var retint = GCommon.MongoDb.VideoOnlineInfo.DeleteMany(lanbda);
            ...
            GCommon.Logger.Debug(
                $"[{Common.LoggerHead}]->VideoOnlineInfo.DeleteMany->启动流媒体服务成功->清理此流媒体下媒体流数量");
        
             GCommon.Logger.Debug(
                $"[{Common.LoggerHead}]->启动流媒体服务成功->{mediaServerId}->清理此流媒体下媒体流");
        ...
        public static bool ShutdownMediaServer(string mediaServerId, out ResponseStruct rs)
        {
            ...
            // }
            GCommon.Logger.Debug(
                $"[{Common.LoggerHead}]->VideoOnlineInfo.DeleteMany->终止流媒体服务成功->清理此流媒体下媒体流数量");
        
             GCommon.Logger.Debug(
                $"[{Common.LoggerHead}]->终止流媒体服务成功->{mediaServerId}->清理此流媒体下媒体流");
        ...
        public static ResKeeperRestartMediaServer RestartMediaServer(string mediaServerId, out ResponseStruct rs)
        {
            ...
            // }
            GCommon.Logger.Debug(
                $"[{Common.LoggerHead}]->重启流媒体服务成功->{mediaServerId}->清理此流媒体下媒体流");
            GCommon.Logger.Debug(
                $"[{Common.LoggerHead}]->VideoOnlineInfo.DeleteMany->重启流媒体服务成功->清理此流媒体下媒体流数量");
